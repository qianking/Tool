...
outline_template_path = r'E:\python\github\Tool\pdf_merge\整合PDF(all)\cover\outline_template_2.docx'
...
if "__main__" == __name__:
    write_word(r'E:\python\github\Tool\pdf_merge\整合PDF(all)\cover', context_cover_2)