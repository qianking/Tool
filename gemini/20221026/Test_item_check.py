    ...
    def HW_Monitor(self):
        ...
        for voltage_info in ADC_info:
            ...
            if vol_num in range(check_limit[0], check_limit[1]):
                self.Variable.upload_log = (vol_name, (1, vol_num, check_limit[0], check_limit[1], None, None))
            else:
        ...
        for fan_info in Fan_info:
            ...
            if fan_num in range(check_limit[0], check_limit[1]):
                self.Variable.upload_log = (fan_name, (1, fan_num, check_limit[0], check_limit[1], None, None))
            else:
        ...
        if count_N == total_count:
            self.Variable.upload_log = (check_item_name, (1, count_N, total_count, total_count, None, None))
        else:
        ...
        for temp_info in Temperature_info:
            ...
            if temp_num > check_limit[0] and temp_num < check_limit[1]:
                self.Variable.upload_log = (temp_name, (1, temp_num, check_limit[0], check_limit[1], None, None))
            else:
        ...
        if count_Normal == total_count:
            self.Variable.upload_log = (check_item_name, (1, count_Normal, total_count, total_count, None, None))
        else:
        ...
        for cpu_temp in CPU_temperature_info:
            ...
            if cpu_temp_num > crit_temp_lower and cpu_temp_num < crit_temp_upper:
                self.Variable.upload_log = (check_item_name, (1, cpu_temp_num, crit_temp_lower, crit_temp_upper, None, None))
            else:
